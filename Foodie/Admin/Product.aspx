                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFie1" runat="server"
...
<%--                                                    <img id="imgProduct" alt="Image Preview" style="max-width: 200px; max-height: 200px;" />--%>
                                            ...
                                            <div class="pb-5">
                                                ...
                                                &nbsp;
                                                <%--<asp:AccessDataSource:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-primary"
                                            ...
                                            <div>
                                                <asp:Image ID="imgProduct" runat="server" CssClass="img-thumbnaile" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6 col-md-8 col-lg-8 mobile inputs">
                                        ...
                                        <div class="crad-block table-border-style">
