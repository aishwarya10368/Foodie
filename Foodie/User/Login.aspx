            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Password is Required" ControlToValidate="txtPassword" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="small" ></asp:RequiredFieldValidator>
