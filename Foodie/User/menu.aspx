    ...
    <div class="container">
      ...
      <div class="filters-content">
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all <%# Regex.Replace(Eval("CategoryName").ToString().ToLower(),@"\s+","") %>" data-id="<%# Eval("CategoryId") %>">
            <div class="box">
              <div>
                <div class="img-box">
                ...
                <div class="detail-box">
                  ...
                  <div class="options">
                    <h6>₹ <%# Eval("Price") %></h6>
                    <asp:LinkButton runat="server" ID="lbAddToCart" CommandNamw="addToCart" CommandArgument='<%# Eval("ProductId") %>'>
